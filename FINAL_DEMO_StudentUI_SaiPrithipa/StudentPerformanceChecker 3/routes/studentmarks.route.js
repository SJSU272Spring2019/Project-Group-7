...
router.post('/getquiz', studentmarks_controller.studentmarks_getquiz);
router.post('/getexam', studentmarks_controller.studentmarks_getexam);
router.post('/getassignment', studentmarks_controller.studentmarks_getassignment);
