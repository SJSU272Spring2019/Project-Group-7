...
class Exam extends Component {
    ...
    componentDidMount(){
     ...
     createExam () {
          ...
          return (
          <div  >
          <button onClick = {this.create.bind(this)} class="btn  btn-md "> + Create Exam</button>
          </div>
      );
...
create = (e) => {
this.props.history.push("/home/subjectInfo/"+localStorage.getItem("course") +"/createExam");
}
	...
	render() {
		...
		return (
            ...
            <p align="right" > {this.createExam()}</p>
     
		<div   class="col-md-9" class = "graph"  style = { { left : "200px", top : "100px" ,width : "1000px"}  }>
